...
class OpenWeatherTests(TestCase):
	...
	def test_test_median_humidity(self,):
		...
		day = Day(hourly=[
			...
			{"temp": 548.3,"humidity": 50, "wind_speed" : 3.21868},
			 {"temp": 822.45, "humidity": 100, "wind_speed": 4.82802}
		]) 
	...
	def test_day_average(self,):
		day = Day(hourly=[
			...
			{"temp": 548.3,"humidity": 50, "wind_speed" : 3.21868},
			 {"temp": 822.45, "humidity": 100, "wind_speed": 4.82802},
			 {"temp": 1096.6, "humidity": 100, "wind_speed": 4.82802}
		]) 
	...
	def test_past_days(self,):
		...
		with patch('requests.request', api_response): 
			day = weather.weather_on(dt=now.timestamp(), stub=now)
